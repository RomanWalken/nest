    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: user_progress_schema_1.UserProgress.name, schema: user_progress_schema_1.UserProgressSchema }
            ])
        ],
        controllers: [progress_controller_1.UserProgressController],
        providers: [],
        exports: [],
    })
], ProgressModule);
